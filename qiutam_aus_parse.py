...
output = open('aus_score.csv', 'a')
header='时间,主队,客队,主队得分,客队得分,上半场主队得分,上半场客队得分,让分,总分盘\n'
urls =['http://nba.win007.com/jsData/matchResult/17-18/l14_1_2017_10.js','http://nba.win007.com/jsData/matchResult/17-18/l14_1_2017_11.js',
'http://nba.win007.com/jsData/matchResult/17-18/l14_1_2017_12.js','http://nba.win007.com/jsData/matchResult/17-18/l14_1_2018_1.js',
'http://nba.win007.com/jsData/matchResult/17-18/l14_1_2018_1.js']
output.write(header)
for url in urls:
